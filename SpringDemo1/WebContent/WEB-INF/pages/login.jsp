				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form id="login-form" action="loginUser" method="post">
							<input type="text" placeholder="Email Or Phone" name="phoneNumberOrEmailId" /> 
							<input type="password"
					...
					<div class="signup-form"><!--sign up form-->
						...
						<form id="register-form" action="registerUser" method="post">
							<input type="text" placeholder="Name" name="name"/> <input type="email"
								placeholder="Email Address" name="email"/> <input type="password"
								placeholder="Password" name="password"/> 
								<input type="text"
								placeholder="Phone Number" name="phoneNumber"/>
								<select name="country"
								class="form-control">
								<option value="NULL_VALUE">Please Select Country</option>
								<option value="India">India</option>
								<option value="USA">USA</option>
							</select> <select name="state" class="form-control" id="state">
								<option value=""></option>
							</select> <select name="city" class="form-control" id="city">
								<option value=""></option>
							</select> <select name="zip" class="form-control" id="zip">
								<option value=""></option>
							</select>

...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index"><img src="resources/images/home/logo.png"
								alt="" /></a>
						</div>
				...
				<div class="col-sm-6">
					<div class="chose_area">
						<ul class="user_option">
							<li><input type="text" id="coupon" name="coupon" min="0">
								<label>Use Coupon Code</label></li>
							<li><a class="btn btn-default check_out" href=""
								id="applyCoupon">Apply Coupon</a></li>
							<li>Use your coupon code and then click on Apply to get
								discount</li>
							<li><div id="successAlert" class="alert alert-success">
									<strong>Congrats!!!</strong> You got Rs <span id="couponAmount"></span>
									off on your total price of Rs <span id="getTotalCost"></span>
									<div class="alert alert-info">
										<strong>Happy Shopping</strong>
									</div>
								</div></li>
								<li><div id="errorAlert" class="alert alert-danger">
									<strong>Sorry!</strong> Either your coupon is invalid or it has expired 
								</div></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<li>Total Quantity <span id="totalQuantity"></span></li>
							<li>Shipping Cost <span id="shippingCost"></span></li>
							<li id="totalCostList">Total <span id="totalCost"></span></li>
						</ul>
						<!-- <a class="btn btn-default update" href="" id="updateCart">Update</a> -->
						<a class="btn btn-default check_out" href="checkout"
							id="checkOutButton">Check Out</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="resources/js/countryState.js"></script>
